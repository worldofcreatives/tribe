...
Revision ID: 09161a94c81e
Revises:
Create Date: 2024-03-12 18:03:21.434628
...
if environment == "production":
    ...
    op.execute(f"ALTER TABLE feedback_media SET SCHEMA {SCHEMA};")
    op.execute(f"ALTER TABLE opp_media SET SCHEMA {SCHEMA};")
    op.execute(f"ALTER TABLE sub_media SET SCHEMA {SCHEMA};")
